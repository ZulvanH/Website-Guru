                        ...
                        <tbody>
                            ...
                            @forelse ($results as $key => $item)
                                <tr>
                                    ...
                                    <td><a href="{{ url('edit-assignment/'.$item['assignment_id']) }}" class="btn btn-sm btn-success">Edit</a></td>
                                    <td><a href="{{ url('delete-assignment/'.$item['assignment_id']) }}" class="btn btn-sm btn-danger">Delete</a></td>
                                </tr>
                            @empty
                                <tr>
