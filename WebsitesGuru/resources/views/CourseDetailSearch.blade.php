                        ...
                        <tbody>
                            ...
                            @foreach ($results as $key => $item)
                                <tr>
                                    ...
                                    <td><a href="{{ url('edit-material/'.$item['material_id']) }}" class="btn btn-sm btn-success">Edit</a></td>
                                    <td><a href="{{ url('delete-material/'.$item['material_id']) }}" class="btn btn-sm btn-danger">Delete</a></td>
                                </tr>
                            @endforeach
                        @else
                            <tr>
