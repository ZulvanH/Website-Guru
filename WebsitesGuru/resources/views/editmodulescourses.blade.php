            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-headers">
                        <h4>Edit Courses </h4>
                        <a href="{{ url('CourseDetail/' .$courseID)}}" class="btn btn-sm btn-primary float-end">Back</a>
                    </div>
                    <div class="card-body">
                        <form action="{{ url('update-material/'.$key)}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form group mb-3">
                            ...
                            <input type="text" name="course_name" value ="{{$editdata['name']}}" class="form-control">
                        </div>
                        <div class="form group mb-3">
                        ...
                        <div class="form group mb-3">
                            <label>youtube</label>
                            <input type="text" name="youtubeurl" value ="{{$editdata['youtube']}}" class="form-control">
                        </div>
                        <div class="form group mb-3">
