            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-headers">
                        ...
                        <a href="{{ url('Discussion')}}" class="btn btn-sm btn-primary float-end">Back</a>
                    </div>
                    <div class="card-body">
                        <form action="{{ url('update-discussion')}}" method="POST">
                        @csrf
                        ...
                        <div class="form group mb-3">
                            ...
                            <input type="text" name="forum_title" value ="{{$editdata['Forum_title']}}" class="form-control">
                        </div>
                        <div class="form group mb-3">
                            <label>Author</label>
                        ...
                        <div class="form group mb-3">
                            ...
                            <input type="text" name="topic_title" value ="{{$editdata['topic_title']}}" class="form-control">
                        </div>

                        <div class="form group mb-3">
                            <label>Topic Content</label>
                            <input type="text" name="topic_content" value ="{{$editdata['topic_content']}}" class="form-control">
                        </div>
