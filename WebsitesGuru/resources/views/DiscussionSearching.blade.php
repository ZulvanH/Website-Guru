	...
	<main>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <form action="{{ url('searchForum')}}" method="GET">
                ...
                <div class="card">
                    <div class="card-headers">
                        ...
                        <a href="add-discussion" class="btn btn-sm btn-primary float-end">Add Discussion</a>
                    </div>
                    <div class="card-body">
                       <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$item['author']}}</td>
                                <td>{{$item['date']}}</td>
                               <td><a href="{{ url('details/'.$item['forum_id']) }}" target="_blank" class="btn-view">View</a></td>
                                <td><a href="{{ url('edit-course/'.$item['forum_id']) }}" class="btn btn-sm btn-success">Edit</a></td>
                                <td><a href="{{ url('delete-course/'.$item['forum_id']) }}" class="btn btn-sm btn-danger">Delete</a></td>
