            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-headers">
                        ...
                        <a href="Discussion" class="btn btn-sm btn-primary float-end">Back</a>
                    </div>
                    <div class="card-body">
                        <form action="{{ url('add-discussion')}}" method="POST">
                        @csrf
                        <br>   <select class="custom-select" id="kelas" name="kelas">
                        ...
                        <div class="form group mb-3">
                            ...
                            <input type="text" name="topic_content" class="form-control">
                        </div>
