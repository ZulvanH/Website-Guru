                       ...
                       <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="{{ url('CourseDetail/'.$key) }}" target="_blank" class="btn-view">View</a></td>
                                {{-- <td>{{$item['kelas']}}</td>
                                <td>{{$item['subject']}}</td>
                                ...
                                <td>
                                    ...
                                    @php
                        $headers = @get_headers($convertedURLs[$key]);
                        if ($headers && strpos($headers[0], '200') !== false) {
                            // Tampilkan video jika tautan embed valid
                            ...
                            // Tampilkan pesan error jika tautan embed tidak valid
                            echo '<span class="error-message">Invalid YouTube Link</span>';
                        }
                    @endphp
                                    @else
                                        {{ $item['youtube'] }}
                                ...
                                <td><a href="{{$item['youtube']}}" target="_blank">{{$item['youtube']}}</a></td> --}}
                                <td><a href="{{ url('edit-course/'.$key) }}" class="btn btn-sm btn-success">Edit</a></td>
