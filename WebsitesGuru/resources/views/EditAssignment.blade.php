            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-headers">
                        ...
                        <a href="Assignment" class="btn btn-sm btn-primary float-end">Back</a>
                    </div>
                    <div class="card-body">
                        <form action="{{ url('update-assignment/'.$key)}}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form group mb-3">
                            ...
                            <input type="text" name="assignment_name" value ="{{$editdata['name']}}" class="form-control">
                        </div>
                        <div class="form group mb-3">
