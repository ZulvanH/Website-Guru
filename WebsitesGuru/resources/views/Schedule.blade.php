...
<div class="logo">
 ...
 <h1>   <p class="centered-text">Teaching Schedule</p></h1>
 <br>
        <div class="con">
        <div class="text-box">
  ...
  @endforeach
  @endif
  {{-- <p>2. Matematika 3/3/2023 07:00</p>
  <p>3. Matematika 3/3/2023 07:00</p> --}}
</div>
</div>
<br><br>
            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-headers">
                        <h4>Schedule List</h4>
                        <a href="add-schedule" class="btn btn-sm btn-primary float-end">Add Schedule</a>
                    </div>
                    <div class="card-body">
                       <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$item['EndTime']}}</td>
                                <td><a href="{{ url('edit-schedule/'.$key) }}" class="btn btn-sm btn-success">Edit</a></td>
                                <td><a href="{{ url('delete-schedule/'.$key) }}" class="btn btn-sm btn-danger">Delete</a></td>
