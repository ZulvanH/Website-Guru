            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-headers">
                        ...
                        <a href="{{ url('CourseDetail/' .$moduleshead['course_id']) }}" class="btn btn-sm btn-primary float-end">Back</a>

                    </div>
                    <div class="card-body">
                        <form action="{{ url('add-material/'.$moduleshead['course_id'])}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form group mb-3">
                            <label>youtube</label>
                            <input type="text" name="youtubeurl" class="form-control">
                        </div>
                        <br>
