                       ...
                       <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$item['author']}}</td>
                                <td>{{$item['date']}}</td>
                               <td><a href="{{ url('details/'.$key) }}" target="_blank" class="btn-view">View</a></td>
                                <td><a href="{{ url('edit-discussion/'.$key) }}" class="btn btn-sm btn-success">Edit</a></td>
                                <td><a href="{{ url('delete-discussion/'.$key) }}" class="btn btn-sm btn-danger">Delete</a></td>
